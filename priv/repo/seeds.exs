...
usuario = [ %{email: "tarcisio@ymail.com", name: "Tarcisio", password: "123456"}, %{email: "cida@ymail.com", name: "Cida", password: "234567"}, %{email: "benicio@ymail.com", name: "Benicio", password: "345678"},]
[
...
tipoConta = [%{nome_tipo_conta: "Corrente"},%{nome_tipo_conta: "Poupança"},%{nome_tipo_conta: "Digital"}]
[
...
operacao = [%{nome_operacao: "Saque"}, %{nome_operacao: "Depósito"}, %{nome_operacao: "Transferência"}, %{nome_operacao: "Investimento"}]
[
  %{nome_operacao: "Saque"},
