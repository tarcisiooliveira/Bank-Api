defmodule BankApi.SendEmail.SendEmail do
  ...
  def send(from_account, to_account_id, operation_id) do
    IO.puts("Send email -> Operation #{operation_id}, from Account #{from_account} to Account #{to_account_id}")
  end

  def send(from_account, operation_id) do
    IO.puts("Send email -> Operation #{operation_id}, from Account #{from_account}")
  end
end
