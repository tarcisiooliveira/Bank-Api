defmodule BankApiWeb.ControllerOperacaoTest do
  ...
  describe "show/2" do
    ...
    test "sucesso delete - retorna mensagem de sucesso quando remove usuario já cadastrado.", %{
      conn: conn
    } do
    ...
    test "error delete - retorna mensagem de erro quando tenta remover usuario inexistente.", %{
      conn: conn
    } do
      insert(:operacao)
